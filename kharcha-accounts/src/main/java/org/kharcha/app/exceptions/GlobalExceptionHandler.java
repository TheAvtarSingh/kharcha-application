...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleUserAlreadyExists(AccountAlreadyExistsException ex) {
        return buildErrorResponse(ex.getMessage(), HttpStatus.CONFLICT);
    }
	
	@ExceptionHandler(AccountNotExistsException.class)
	public ResponseEntity<Object> handleUserNotExists(AccountNotExistsException ex){
